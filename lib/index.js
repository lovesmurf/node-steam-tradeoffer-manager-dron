...
TradeOfferManager.prototype.getTradeOffer = function (options, callback) {
	this._requestCommunity.get({
		...
		var offer = $(`div.tradeoffer#tradeofferid_${options.tradeOfferId}`);
		//console.log(response.data);

		// var $ = cheerio.load(body);
		// console.log(body);
		// console.log(`div.tradeoffer#tradeofferid_${options.tradeOfferId}`)
		// let offer = $(`div.tradeoffer#tradeofferid_${options.tradeOfferId}`);
		//
		// console.log({LENGTH: offer.length})
		//
		// if (!offer.length) {
		// 	return callback(new Error('Offer not found'));
		// }
		//
