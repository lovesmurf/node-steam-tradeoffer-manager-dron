...
TradeOfferManager.prototype.getSendedOffersNonApi = function (callback) {
	this._requestCommunity.get({
		...
		for (let i = 0; i < offers.length; i++) {
			...
			let receivedItemsHtml = offer('div.tradeoffer_items.primary.div.trade_item');

			console.log(receivedItemsHtml.length)
			...
			// 	console.log(givenItemsHtml[d].attribs['data-economy-item']);
			// 	givenItems.push({
